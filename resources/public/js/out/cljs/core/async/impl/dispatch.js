...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13315 = (0);while(true){
var m_13316 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13316 == null))
{} else
{m_13316.call(null);
if((count_13315 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13317 = (count_13315 + (1));
count_13315 = G__13317;
continue;
}
} else
{}
