...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13321 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t13321 = (function (val,box,meta13322){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13321.cljs$lang$type = true;
cljs.core.async.impl.channels.t13321.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13321";
cljs.core.async.impl.channels.t13321.cljs$lang$ctorPrWriter = (function (this__4213__auto__,writer__4214__auto__,opt__4215__auto__){return cljs.core._write.call(null,writer__4214__auto__,"cljs.core.async.impl.channels/t13321");
});
cljs.core.async.impl.channels.t13321.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t13321.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13323){var self__ = this;
var _13323__$1 = this;return self__.meta13322;
});
cljs.core.async.impl.channels.t13321.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13323,meta13322__$1){var self__ = this;
var _13323__$1 = this;return (new cljs.core.async.impl.channels.t13321(self__.val,self__.box,meta13322__$1));
});
cljs.core.async.impl.channels.__GT_t13321 = (function __GT_t13321(val__$1,box__$1,meta13322){return (new cljs.core.async.impl.channels.t13321(val__$1,box__$1,meta13322));
});
}
return (new cljs.core.async.impl.channels.t13321(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_13324 = self__.takes.pop();if((taker_13324 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13324))
{var take_cb_13325 = cljs.core.async.impl.protocols.commit.call(null,taker_13324);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13325,taker_13324,this$__$1){
return (function (){return take_cb_13325.call(null,null);
});})(take_cb_13325,taker_13324,this$__$1))
);
} else
{}
{
